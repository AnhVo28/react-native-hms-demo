...
import DTMConfig from '../android/app/src/main/assets/containers/DTM-ac1262037548107381756927c3d00aae.json'
...
export default class DtmComponent extends React.Component {
  ...
  async customTag() {
    ...
    try {
      ...
      console.log('params: ', sampleCondition[2]  )
